...
calc = GPAW('Cr2O3_relaxed.gpw', txt=None)
...
magmoms[4] = [0.0, 0.0, 5.0]
magmoms[5] = [0.0, 0.0, -5.0]
magmoms[6] = [0.0, 0.0, -5.0]
magmoms[7] = [0.0, 0.0, 5.0]
...
for i in range(0, res + 1):
    ...
    calc = GPAW(**params, txt=f'structure_{i}_Ey.txt')
